...
describe('WalletSession', () => {
  ...
  describe('request handling', () => {
    ...
    it('emits request event with decrypted params', () => {
      ...
      transport.receive({
        ...
        sealed: sealPayload(sessionKey, channelId, 0, params),
      } as ProtocolMessage);
  ...
  describe('approve/reject', () => {
    ...
    it('approve sends encrypted ok response', () => {
      ...
      const { data } = unsealPayload(sessionKey, channelId, resMsg.sealed);
    ...
    it('reject sends encrypted error response', () => {
      transport.receive({
        ...
        id: 'req-2', from: dappKp.publicKeyB64,
        method: 'wallet_signMessage',
        sealed: sealPayload(sessionKey, channelId, 0, { message: 'test' }),
      } as ProtocolMessage);
  ...
  describe('pushEvent', () => {
    ...
    it('sends encrypted event message', () => {
      ...
      const { data } = unsealPayload(sessionKey, channelId, evtMsg.sealed);
